...
import { Checkbox, CheckboxContainer, CheckboxLabel, EmployeeFormCwContainer } from "./styles";
import Button from "components/Button/Button";
import { EmployeeFormValue, EMPLOYEE_FIELD_NAMES } from './types';

function EmployeeFormCw() {
  ...
  return (
    <EmployeeFormCwContainer onSubmit={formik.handleSubmit}>
      <Input
    ...
    </EmployeeFormCwContainer>
  )
}

export default EmployeeFormCw;
